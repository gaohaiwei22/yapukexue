        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" action="{{URL('admin/curriculum/update')}}/{{ $curriculum->id }}" method="post" enctype="multipart/form-data" >
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="_method" value="put">
                        <input id="getimage" type="hidden" name="picture" value="{{ $curriculum->picture }}">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="name" class="form-control" value="{{ $curriculum->name }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">数字</label>
                                <div class="col-sm-4">
                                    <input type="text" name="number" class="form-control" value="{{ $curriculum->number }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">课程名称</label>
                                <div class="col-sm-4">
                                    <input type="text" name="Course" class="form-control" value="{{ $curriculum->Course }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3"  class="col-sm-2 control-label">课程概括</label>
                                <div class="col-sm-4">
                                    <textarea cols="23" rows="5" type="text" name="Generalization" ><?php echo $curriculum['Generalization'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">建议标题</label>
                                <div class="col-sm-4">
                                    <input type="text" name="title" class="form-control" value="{{ $curriculum->title }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3"  class="col-sm-2 control-label">建议简介</label>
                                <div class="col-sm-4">
                                    <textarea cols="23" rows="5" type="text" name="introduction" ><?php echo $curriculum['introduction'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">下载</label>
                                <div class="col-sm-4">
                                    <input type="text" name="Practical" class="form-control" value="{{ $curriculum->Practical }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">购买</label>
                                <div class="col-sm-4">
                                    <input type="text" name="link" class="form-control" value="{{ $curriculum->link }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">备课</label>
                                <div class="col-sm-4">
                                    <input type="text" name="download" class="form-control" value="{{ $curriculum->download }}">
                                </div>
                            </div>
                            <div class="form-group">
