        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" action="{{URL('admin/course/update')}}/{{ $course->id }}" method="post" enctype="multipart/form-data" >
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="_method" value="put">
                        <input id="getimage" type="hidden" name="picture" value="{{ $course->picture }}">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img id="getimg" src="{{ env('QINIU_DOMAIN')}}/{{ $course->picture }}" height="50"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea cols="23" rows="5" type="text" name="Generalization" ><?php echo $course['Generalization'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea cols="23" rows="5" type="text" name="introduction" ><?php echo $course['introduction'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3"   class="col-sm-2 control-label">下载</label>
                                <div class="col-sm-4">
                                    <input type="text" name="Practical" class="form-control" value="{{ $course->Practical }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="download" class="form-control" value="{{ $course->download }}">
                                </div>
                            </div>
                            <div class="form-group">
