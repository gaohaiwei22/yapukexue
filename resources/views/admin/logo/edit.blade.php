        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" action="{{URL('admin/logo/update')}}/{{ $logo->id }}" method="post" enctype="multipart/form-data" >
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="_method" value="put">
                        <input id="getimage" type="hidden" name="logo" value="{{ $logo->logo }}">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img id="getimg" src="{{ env('QINIU_DOMAIN')}}/{{ $logo->logo }}" height="50"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="radio" name="status"  value="0"<?php echo $logo['status']=="0"?"checked":"";?>/>通过
                                    <input type="radio" name="status"  value="1"<?php echo $logo['status']=="1"?"checked":"";?>/>禁用
                                </div>
                            </div>
                        </div><!-- /.box-body -->
