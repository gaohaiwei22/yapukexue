@extends('admin.base')
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"><button class="btn btn-sm btn-primary" onclick="window.location='{{URL('admin/carousel/create')}}'">发布信息</button></h3>
                  <div class="box-tools">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <td><button onclick="doDel({{$v->id}})" class="btn btn-xs btn-danger">删除</button>                     
						<a href="{{URL('admin/carousel')}}/{{$v->id}}/edit" class="btn btn-xs btn-danger">编辑</a>
					  </td>
                    </tr>
                  @endforeach
                  </table>
    ...
    @section("myscript")
      <script type="text/javascript">
            function doDel(id){
                if(confirm('确定要删除吗？')){
                    $("#mydeleteform").attr("action","{{url('admin/carousel')}}/"+id).submit();
                }
            }
      </script>
    @endsection
