          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" action="{{URL('admin/navigation/update')}}/{{ $navigation->id }}" method="post">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-4">
                              <input type="text" name="names" class="form-control" value="{{ $navigation->names }}">
                          </div>
                      </div>
                     <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-4">
                              <label class="radio-inline">
                                  <input type="radio" name="status" id="inlineRadio1" {{ ($navigation->status == 0)?"checked":"" }} value="0"> 启用
                              </label>
                              <label class="radio-inline">
                                  <input type="radio" name="status" id="inlineRadio2" {{ ($navigation->status == 1)?"checked":"" }} value="1"> 禁用
                              </label>
                          </div>
                      </div>
                  </div><!-- /.box-body -->
