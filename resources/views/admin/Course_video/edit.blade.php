        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <form class="form-horizontal" action="{{URL('admin/Course_video/update')}}/{{ $Course_video->id }}" method="post" enctype="multipart/form-data" >
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="_method" value="put">
                        <input id="getimag" type="hidden" name="video" value="{{ $Course_video->video }}">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="name" class="form-control" value="{{ $Course_video->name }}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea cols="23" rows="5" type="text" name="introduce" ><?php echo $Course_video['introduce'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="radio" name="status"  value="0"<?php echo $Course_video['status']=="0"?"checked":"";?>/>通过
                                    <input type="radio" name="status"  value="1"<?php echo $Course_video['status']=="1"?"checked":"";?>/>禁用
                                </div>
                            </div>
                        </div><!-- /.box-body -->
                ...
                $(document).ready(function()
                {
                    ...
                    $("#y").uploadFile({
                        ...
                        onSuccess: function (files,data,xhr,pd) {
                            ...
                            var newnode = '<input type="hidden" id="'+data.filename+'" name="video" value="'+data.filename+'" >';
