            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
				 ...
				 <form class="form-horizontal" action="{{URL('admin/product/store')}}" method="post" id="myform" enctype="multipart/form-data">
                  <input type="hidden" name="_token" value="{{  csrf_token() }}">
				  <input id="yapu" type="hidden" name="product_picture">
                  <div class="box-body">
