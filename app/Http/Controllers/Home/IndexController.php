...
//==============================================================================>
        ...
        return view('home.Index.index',["navigation"=>$navigation,'logo'=>$logo,'rightnavigation'=>$rightnavigation,"diagram"=>$diagram,'bottom'=>$bottom,"params"=>$params,"carousel"=>$carousel,"carousely"=>$carousely,"title"=>$title,"product_table"=>$product_table]);
